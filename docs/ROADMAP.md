...
| 1.13 ⬜ | **Accessibility & polish pass** | Contrast, focus order, screen-reader labels, large tap targets verified; performance budget on mobile. |

> **Redesign note:** sub-phases 1.10–1.12 (exact-age onboarding, per-subject themed tracks + reachable profile, doubled content depth) shipped together as one cohesive redesign phase.
